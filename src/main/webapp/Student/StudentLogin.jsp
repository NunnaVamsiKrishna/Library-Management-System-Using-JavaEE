...
<body style="background-color: #001a4d; color: white;">
<h2 align="center">E-LIBRARY</h2>
<br><br>
<h3 align=center><u>Student Login</u></h3>
<center>
<form method="post" action="StudentHome.jsp">
Student ID: <input type="text" name="uname" required style="width: 40vh; height: 5vh; border-radius: 15px; border: solid; padding: 4px"><br><br>
